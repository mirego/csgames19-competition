...
class IngredientAdapter(var items:List<Ingredient>, val context: Context, val listener: OnItemClickListener) : RecyclerView.Adapter<IngredientAdapter.ItemViewHolder>() {
    ...
    interface OnItemClickListener {
        fun onItemClickListener(item: Ingredient)
    }
}